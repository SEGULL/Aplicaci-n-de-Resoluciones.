...
public class ResolucionDAOImpl extends BaseDAOHibernate implements ResolucionDAO {
    ...
    public List<ResolEmitida> FindResolucionemitida(String Dni){
		...
		queryBuffer.append("select  docente.Dni,resolemitida.CodResolucion,"
				+ "resolucion.Nombre, item_resol.Campo,"
				+ "detalle.CargoActual,detalle.CargoDesempeñar,"
				...
				+ " resolemitida.IdRes_Emi=detalle.IdRes_Emi and Docente.dni='"+Dni+"'");
